      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        >
          ...
          <a
            ...
            className="cta-button-green w-full sm:w-auto !flex items-center justify-center gap-2 text-xs sm:text-base text-center whitespace-nowrap !px-4 sm:!px-9"
          >
            <svg viewBox="0 0 32 32" className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" aria-hidden="true">
              <path
                fill="currentColor"
