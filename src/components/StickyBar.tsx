...
const StickyBar = () => {
  ...
  return (
    ...
    >
      ...
      <a href="https://chk.eduzz.com/8017D61Q07" target="_blank" rel="noopener noreferrer" className="cta-button w-[90%] max-w-md mx-auto px-4 py-2.5 text-[11px] sm:text-sm md:text-base md:w-auto md:whitespace-nowrap leading-tight text-center flex items-center justify-center sm:mx-0">
        QUERO ACESSAR AGORA
      </a>
    </div>
  );
