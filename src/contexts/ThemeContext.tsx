...
export type ThemeVersion = 'dark' | 'light' | 'fullblue';
...
// Returns background class for a section based on theme and section index
export const getSectionBg = (theme: ThemeVersion, index: number, isWhiteEligible = true): string => {
  if (theme === 'light' && isWhiteEligible && index % 2 === 1) {
